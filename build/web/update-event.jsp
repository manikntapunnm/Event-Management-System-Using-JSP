<%-- 
    ...
    Created on : 27-Jul-2023, 12:26:10 pm
    Author     : manikanta
--%>
...
<div class="pcoded-main-container">
  ...
  <form action="update-event-action.jsp?id=<%=rs.getString(1)%>" method="post">
                        <div class="mb-3 mt-3">
                          <label for="title" class="mb-0 pb-0">Event Title:</label>
                          <input type="text" class="form-control" id="title" placeholder="" name="title" value="<%= rs.getString(2) %>">
                        </div>
                        <div class="mb-3">
                            <label for="status" class="mb-0 pb-0">Event Status:</label>
                            <input type="text" class="form-control" id="" placeholder="" name="status" value="<%= rs.getString(3) %>">
                          </div>
                          <div class="mb-3" >
                            <label for="min" class="mb-0 pb-0">Minimum Guest:</label>
                            <input type="number" class="form-control mb-0 pb-0" id="" placeholder="" name="ming" value="<%= rs.getString(4) %>">
                          </div>
                          <div class="mb-3" >
                            <label for="max" class="mb-0 pb-0">Maximum Guest:</label>
                            <input type="number" class="form-control mb-0 pb-0" id="" placeholder="" name="maxg" value="<%= rs.getString(5) %>">
                          </div>
                          <div class="mb-3">
                            <label for="date" class="mb-0 pb-0">Date:</label>
                            <input type="date" class="form-control mb-0 pb-0" id="" placeholder="" name="date" value="<%= rs.getString(6) %>">
                          </div>
                          <div class="mb-3">
                            <label for="cost" class="mb-0 pb-0">Cost:</label>
                            <input type="text" class="form-control mt-0" id="" placeholder="" name="cost" value="<%= rs.getString(7) %>">
                          </div>
                          <div class="mb-3">
                            <label for="des" class="mb-0 pb-0">Description:</label>
                            <input type="text" class="form-control" id="" placeholder="" name="des" value="<%= rs.getString(8) %>">
                          </div>
