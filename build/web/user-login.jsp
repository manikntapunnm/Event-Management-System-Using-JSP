<%-- 
    Document   : user-login
    Created on : 27-Jul-2023, 10:03:36 am
    Author     : manikanta
--%>
	...
	<header class="header-section clearfix">
		...
		<div class="header-right">
			...
			<!--<div class="user-panel">
				<a href="user-login.jsp" class="register">User</a>
			</div> -->
		</div>
		<ul class="main-menu">
            ...
            <li><a href="user-login.jsp" class="login">Student</a></li>
			...
			<div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
			  <form>
				...
				<div class="text-center text-lg-start mt-4 pt-2">
				 <a href="home.jsp"> <button type="button" class="btn btn-primary btn-lg"
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://codebook.in/" target="_blank">Codebook.in</a>
