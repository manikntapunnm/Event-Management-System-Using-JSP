<%-- 
    Document   : eventman-dashboard
    Created on : 27-Jul-2023, 12:11:39 pm
    Author     : manikanta
--%>
...
%>
				...
				<div class="">
					<div class="main-menu-header">
						...
						<div class="user-details">
							<div id="more-details"><%= session.getAttribute("event") %><br>Event Manager<i class="fa fa-caret-down"></i></div>
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-hasmenu">
					    ...
					    <ul class="pcoded-submenu">
					        <li><a href="add-event.jsp" target="">Add Event</a></li>
					        <li><a href="manage-event.jsp" target="">Manage Event</a></li>
					    </ul>
					</li>
                    <li class="nav-item">
	...
	<!-- [ Header ] end -->
       ...
       <% 
    int totalEvents = 0;
    // Retrieve the total number of events from the database
    String countEventsQuery = "SELECT COUNT(*) AS totalEvents FROM events";
    Statement countEStatement = con.createStatement();
    ResultSet countEventsResult = countEStatement.executeQuery(countEventsQuery);
    if (countEventsResult.next()) {
        totalEvents = countEventsResult.getInt("totalEvents");
    }
    countEventsResult.close();
    countEStatement.close();
%>
    ...
    String countStudentsQuery = "SELECT COUNT(*) AS totalStudents FROM student";
    Statement countStudentsStatement = con.createStatement();
    ResultSet countStudentsResult = countStudentsStatement.executeQuery(countStudentsQuery);
    if (countStudentsResult.next()) {
        totalStudents = countStudentsResult.getInt("totalStudents");
    }
    countStudentsResult.close();
    countStudentsStatement.close();
    ...
    String countUpcomingEvents = "SELECT COUNT(*) AS UpcomingEvents FROM events WHERE status='upcoming'";
    Statement countUStatement = con.createStatement();
    ResultSet countUResult = countUStatement.executeQuery(countUpcomingEvents);
    if (countUResult.next()) {
        UpcomingEvents = countUResult.getInt("UpcomingEvents");
    }
    countUResult.close();
    countUStatement.close();
%>
<% 
    int OngoingEvents = 0;
    // Retrieve the total number of ongoing events from the database
    String countOngoingEventsQuery = "SELECT COUNT(*) AS OngoingEvents FROM events WHERE status='ongoing'";
    Statement countOStatement = con.createStatement();
    ResultSet countOngoingEventsResult = countOStatement.executeQuery(countOngoingEventsQuery);
    if (countOngoingEventsResult.next()) {
        OngoingEvents = countOngoingEventsResult.getInt("OngoingEvents");
    }
    countOngoingEventsResult.close();
    countOStatement.close();
%>

<% 
    int EndedEvents = 0;
    // Retrieve the total number of ended events from the database
    String countEndedEventsQuery = "SELECT COUNT(*) AS EndedEvents FROM events WHERE status='ended'";
    Statement countEdStatement = con.createStatement();
    ResultSet countEndedEventsResult = countEdStatement.executeQuery(countEndedEventsQuery);
    if (countEndedEventsResult.next()) {
        EndedEvents = countEndedEventsResult.getInt("EndedEvents");
    }
    countEndedEventsResult.close();
    countEStatement.close();
%>
...
<%-- 
    int Enroll = 0;
    // Retrieve the total number of students who have participated in events with status other than "Pending"
    String EnrollStudent = "SELECT COUNT(*) AS Enroll FROM student WHERE event != 'Pending'";
    Statement EnrollStudentStatement = con.createStatement();
    ResultSet EnrollStudentResult = EnrollStudentStatement.executeQuery(EnrollStudent);
    if (EnrollStudentResult.next()) {
        Enroll = EnrollStudentResult.getInt("Enroll");
    }
    EnrollStudentResult.close();
    EnrollStudentStatement.close();
--%>



           
            <% String selectedEvent = (String) session.getAttribute("event");
            int enrollCount = 0; // Declare the variable 'enrollCount' with broader scope

            if (selectedEvent != null) {
                String enrollStudentQuery = "SELECT COUNT(*) AS Enroll FROM student WHERE event = ?";
                try {
                    
                    PreparedStatement enrollStudentStatement = con.prepareStatement(enrollStudentQuery);
                    enrollStudentStatement.setString(1, selectedEvent);

                    ResultSet enrollStudentResult = enrollStudentStatement.executeQuery();
                    if (enrollStudentResult.next()) {
                        enrollCount = enrollStudentResult.getInt("Enroll");
                    }
                    enrollStudentResult.close();
                    enrollStudentStatement.close();
            ...
            <div class="col-lg-7 col-md-12">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card support-bar overflow-hidden">
                            <div class="card-body pb-0">
                                <h2 class="m-0"><h1 class="mb-0"><%= enrollCount %></h1></h2>
                                <span class="text-c-blue">Enrolled</span>
                                <p class="mb-3 mt-3">Total number of Students for <%= session.getAttribute("event") %>.</p>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card support-bar overflow-hidden">
                            <div class="card-body pb-0">
                                <h2 class="m-0"><h1 class="mb-0"><%= totalStudents %></h1></h2>
                                <span class="text-c-green">Total Students</span>
                                <p class="mb-3 mt-3">Total number of Students that come in.</p>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h4 class="text-c-yellow"><%=UpcomingEvents %></h4>
                                        <h6 class="text-muted m-b-0">Upcoming</h6>
                                    </div>
                            ...
                            <div class="card-footer bg-c-yellow">
                                <div class="row align-items-center">
                                    <div class="col-9">
                                        <p class="text-white m-b-0">Events</p>
                                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h4 class="text-c-green"><%= OngoingEvents %></h4>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h4 class="text-c-red"><%= EndedEvents %></h4>
                                        <h6 class="text-muted m-b-0">Ended</h6>
                                    </div>
                                    <div class="col-4 text-right">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h4 class="text-c-blue"><%= totalEvents %></h4>
