<%-- 
    ...
    Created on : 27-Jul-2023, 12:27:41 pm
    Author     : manikanta
--%>
...
<html lang="zxx">
 ...
 ResultSet rs = null;
         ...
         String title = "soft skills"; // Corrected the assignment
 ...
 try {
     ...
     if (rs.next()) {
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img src="data:image/jpeg;base64, <%= base64Image %>" alt="" width="500" height="500">
                </div>
                <div class="col-lg-6">
                    <form action="soft-skills-action.jsp?title=<%=rs.getString(2)%>" method="post">
