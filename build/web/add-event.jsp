<%-- 
    Document   : add-event
    Created on : 27-Jul-2023, 12:11:05 pm
    Author     : manikanta
--%>
        ...
        <div class="navbar-wrapper  ">
            <div class="navbar-content scroll-div ">
                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item">
                        <a href="eventman-dashboard.jsp" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-home"></i></span><span class="pcoded-mtext">Home</span></a>
                    </li>
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-layout"></i></span><span class="pcoded-mtext">Event
                                Management</span></a>
                    ...
                    <li class="nav-item">
                        <a href="view-student.jsp" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-user"></i></span><span class="pcoded-mtext">View
                                Students</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="event-feedback_1.jsp" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-layout"></i></span><span class="pcoded-mtext">Event
                                FeedBack</span></a>
                    </li>
                    <!--<li class="nav-item pcoded-menu-caption">
            ...
            <div class="row">
                ...
                <div class="col-xl-8  col-md-8">
                    <div class="card table-card">
                        ...
                        <form action="add-event-action.jsp" method="post" enctype="multipart/form-data">
                            <div class="mb-1 mt-1">
                                <label for="title" class="mb-0 pb-0 ml-5">Event Title:</label>
                                <input type="text" class="form-control" id="title" placeholder="" name="title">
                            </div>
                            <div class="mb-3 mt-3">
                                <label for="status" class="mb-0 pb-0 ml-5">Event Status:</label>
                                <input type="text" class="form-control" id="" placeholder="" name="status">
                            </div>
                            <div class="mb-3">
                                <label for="min" class="mb-0 pb-0 ml-5">Minimum Guest:</label>
                                <input type="number" class="form-control mb-0 pb-0" id="" placeholder="" name="ming">
                            </div>
                            <div class="mb-3">
                                <label for="max" class="mb-0 pb-0 ml-5">Maximum Guest:</label>
                                <input type="number" class="form-control mb-0 pb-0" id="" placeholder="" name="maxg">
                            </div>
                            <div class="mb-3">
                                <label for="date" class="mb-0 pb-0 ml-5">Date:</label>
                                <input type="date" class="form-control mb-0 pb-0" id="" placeholder="" name="date">
                            </div>
                            <div class="mb-3">
                                <label for="cost" class="mb-0 pb-0 ml-5">Cost:</label>
                                <input type="text" class="form-control mt-0" id="" placeholder="" name="cost">
                            </div>
                            <div class="mb-3">
                                <label for="des" class="mb-0 pb-0 ml-5">Description:</label>
                          ...
                          <label class="form-check-label">
                            ...
                            <button type="submit" class="btn btn-primary ml-5 mb-3">Create Event</button>
                        </form>
                    </div>
                </div>
                <div class="col-2"></div>
