<%-- 
    Document   : livestream
    Created on : 27-Jul-2023, 12:21:51 pm
    Author     : manikanta
--%>
...
<body>
	...
	<header class="header-section clearfix">
		...
		<!--ul class="main-menu">
			...
			<li><a href="signin-after.jsp">View Events</a>
...
String title = "LiveStream"; // Corrected the assignment
...
%>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form action="livestream-action.jsp?title=<%=rs.getString(2)%>" method="post">
