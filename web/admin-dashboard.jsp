<%-- 
    ...
    Created on : 27-Jul-2023, 12:17:13 pm
    Author     : manikanta
--%>
...
<body class="">
	...
	<!-- [ Header ] end -->
      <%@ page import="java.sql.*" %>  
       ...
       %>
        ...
        <% 
            int totalEventManagers = 0;
        // Retrieve the total number of leaves from the database
        String countQuery = "SELECT COUNT(*) AS totalEventManagers FROM eventman";
        Statement countEStatement = con.createStatement();
        ResultSet countResult = countEStatement.executeQuery(countQuery);
        if (countResult.next()) {
            totalEventManagers = countResult.getInt("totalEventManagers");
        }
        countResult.close();
    ...
    // Retrieve the total number of students with OTP Validated status from the database
    String countOtpValidatedQuery = "SELECT COUNT(*) AS verified FROM student WHERE otpstatus='Verified'";
    Statement countOtpValidatedStatement = con.createStatement();
    ResultSet countOtpValidatedResult = countOtpValidatedStatement.executeQuery(countOtpValidatedQuery);
    if (countOtpValidatedResult.next()) {
        verified = countOtpValidatedResult.getInt("verified");
    }
    countOtpValidatedResult.close();
    countOtpValidatedStatement.close();
    
    // Retrieve the total number of students with OTP Pending status from the database
    String countOtpPendingQuery = "SELECT COUNT(*) AS pending FROM student WHERE otpstatus='Pending'";
    Statement countOtpPendingStatement = con.createStatement();
    ResultSet countOtpPendingResult = countOtpPendingStatement.executeQuery(countOtpPendingQuery);
    if (countOtpPendingResult.next()) {
        pending = countOtpPendingResult.getInt("pending");
    }
    countOtpPendingResult.close();
    countOtpPendingStatement.close();
%>
                    ...
                    <div class="col-sm-6">
                        <div class="card support-bar overflow-hidden">
                            <div class="card-body pb-0">
                                <h2 class="m-0"><h1 class="mb-0"><%= totalEventManagers %></h1></h2>
                                <span class="text-c-blue">Total Event Managers</span>
                                <p class="mb-3 mt-3">Total number of EventManagers that come in.</p>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h4 class="text-c-red"><%= pending%></h4>
                                        <h6 class="text-muted m-b-0">OTP</h6>
                                    </div>
                                    <div class="col-4 text-right">
                            ...
                            <div class="card-footer bg-c-red">
                                <div class="row align-items-center">
                                    <div class="col-9">
                                        <p class="text-white m-b-0">Pending</p>
                                    </div>
                                    <div class="col-3 text-right">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h4 class="text-c-blue"><%= verified%></h4>
                                        <h6 class="text-muted m-b-0">OTP</h6>
                                    </div>
                                    <div class="col-4 text-right">
                            ...
                            <div class="card-footer bg-c-blue">
                                <div class="row align-items-center">
                                    <div class="col-9">
                                        <p class="text-white m-b-0">Verified</p>
                                    </div>
                                    <div class="col-3 text-right">
                                        <i class="feather icon-trending-down text-white f-16"></i>
                                    </div>
