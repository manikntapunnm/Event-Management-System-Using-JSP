<%-- 
    Document   : add-event-manager
    Created on : 27-Jul-2023, 12:09:45 pm
    Author     : manikanta
--%>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12">
                <div class="card table-card">
                    ...
                    <form action="add-event-manager-action.jsp" method="post" enctype="multipart/form-data">
                        <div class="mb-1 mt-1">
                          <label for="fname" class="mb-0 pb-0">First Name:</label>
                          <input type="text" class="form-control" id="title" placeholder="" name="firstname">
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="lname" class="mb-0 pb-0">Last Name:</label>
                            <input type="text" class="form-control" id="" placeholder="" name="lastname">
                          </div>
                          <div class="mb-3" >
                            <label for="email" class="mb-0 pb-0">Email:</label>
                            <input type="text" class="form-control mb-0 pb-0" id="" placeholder="" name="email">
                          </div>
                          <div class="mb-3" >
                            <label for="phone" class="mb-0 pb-0">Phone No:</label>
                            <input type="number" class="form-control mb-0 pb-0" id="" placeholder="" name="phone">
                          </div>
                          <div class="mb-3">
                            <label for="event-n" class="mb-0 pb-0">Event Type:</label>
                            <input type="text" class="form-control mt-0" id="" placeholder="" name="event">
                          </div>
                          <!--<div class="mb-3">
                            <label for="date" class="mb-0 pb-0">Date:</label>
                            <input type="number" class="form-control mb-0 pb-0" id="" placeholder="" name="date">
                          </div>-->
                        ...
                        <br>
                        <button type="submit" class="btn btn-primary"><!--a href="manage-event-manager.jsp" class="text-light"-->Add Event Manager</a></button>
                      </form>
