<%-- 
    Document   : seminar-py
    Created on : 27-Jul-2023, 12:28:44 pm
    Author     : manikanta
--%>
...
String title = "Seminar on Python"; // Corrected the assignment
...
%>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form action="seminar-py-action.jsp?title=<%=rs.getString(2)%>" method="post">
