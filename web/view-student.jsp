<%-- 
    ...
    Created on : 27-Jul-2023, 12:25:10 pm
    Author     : manikanta
--%>
            ...
            <div class="pcoded-content">
                ...
                <div class="col-xl-12  col-md-12">
                    <div class="card table-card">
                        ...
                        //String selectedEvent = "Musical Nights";
                        try {
...
String selectedEvent = (String) session.getAttribute("event");
    ...
    String countQuery = "SELECT COUNT(*) AS total FROM student WHERE event = ? ";
   ...
   String query = "SELECT * FROM student WHERE event = ? LIMIT ?, ?";
...
statement.setInt(2, requestsPerPage);
    ...
    ResultSet resultSet = statement.executeQuery();
                        ...
                        try {
                            ...
                            // Assuming you have retrieved the event name from the session
                            String selectedEvent = (String) session.getAttribute("event");

                            // Retrieve the total number of leave requests from the database for the selected event
                            String countQuery = "SELECT COUNT(*) AS total FROM student WHERE event = ?";
                            PreparedStatement countStatement = connection.prepareStatement(countQuery);
                            countStatement.setString(1, selectedEvent);
                            ...
                            statement.setInt(3, requestsPerPage);
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><textarea rows="1" cols="10"><%= resultSet.getString("college") %></textarea></td>
                                      ...
                                      <td>
                                          <div class="row">
                                              <form action="updateaction.jsp" method="post">
                                                  ...
                                                  <button type="submit" class="btn btn-outline-success btn-sm btn-icon-text mr-3"
                                              ...
                                              <form action="updateaction.jsp" method="post">
                                                  <input type="hidden" name="id" value="<%= resultSet.getString("id") %>">
                                                  <button type="submit" class="btn btn-outline-warning btn-sm btn-icon-text mr-3"
    ...
    String deleteUrl = "removeaction.jsp?id=" + id;
%>
